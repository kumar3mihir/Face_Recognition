...
#     print("No data found. Ensure there are .npy files in the dataset directory.")
#     exit()
...
while True:
    ...
    for face in faces:
        ...
        # Ensure the face coordinates are within the frame bounds
        ...
        # Ensure the extracted face section is not empty
